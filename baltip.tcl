...
package provide baltip 1.3.0.1
  ...
  if {[winfo exists $w] || $w eq {}} {
    ...
    if {$text ne {}} {
      ...
      if {$geo ne {}} {
        ...
        if {$index>-1} {
          # tip for menu items
          set my::ttdata($w,$index) $optvals
          set my::ttdata(LASTMITEM) {}
          my::BindToEvent $w <<MenuSelect>> ::baltip::my::MenuTip $w %W
        } elseif {$ttag ne {}} {
          # tip for text tags
